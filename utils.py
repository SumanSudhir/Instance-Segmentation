...
def get_layer_names():
    ...
    class_string_to_name = get_string_to_name()
    layer0_name = [class_string_to_name[s] for s in sorted(layer0)]
    layer1_name = [class_string_to_name[s] for s in sorted(layer1)]
